...
const counterSlice = createSlice({
  // Slice'in adı
  name: "counter",
  // Başlangıç state'i, number türünde olmalıdır.
...
// slice'İn oluşturduğu reducer fonksiyonunu store'a tanıtmak için export ederiz
export default counterSlice.reducer;

// sliice'in oluşturduğu aksiyon oluşturan fonksiyonları bileşenlerde kullanabilmek için export ederiz
